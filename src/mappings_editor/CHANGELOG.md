...
* only export `related_score` when a sub-technique has an assigned score ([b5ff4ac](https://github.com/david-lcl-lab/mappings-editor/commit/b5ff4ac72fde65c4b64818e333cf42b7e9f335b7))
